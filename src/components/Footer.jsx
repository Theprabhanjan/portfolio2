            ...
            <div className='flex flex-col  sm:grid  grid-cols-[3fr_1fr_1fr] gap-14  my-10  text-sm border-t-[0.1px]  py-2 border-cyan-200/20 '>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-1 text-gray-800'>
                        ...
                        <a href='mailto:prabhanjandhobale@outlook.com'><a className='text-gray-400/80'>prabhanjandhobale.skn.entc@gmail.com</a> </a>
                        <a href='mailto:prabhanjandhobale.skn.entc@gmail.com' className='text-gray-400/80'>prabhanjandhobale18@gmail.com (personal)</a>
