    ...
    <div className='min-h-[100vh] flex flex-col  items-center  text-white pt-10 mt-5 animate-slideUp'>
      <div className='flex flex-col items-start sm:p-3  my-4 shadow-sm shadow-cyan-500/20 rounded-lg bg-[#121212] pt-3'>
        ...
        <div className='flex flex-col-reverse md:flex-row p-3 md:p-0 justify-between items-center'>
          ...
          <div className='rounded-full bg-gradient-to-b from-blue-500 via-teal-400 to-cyan-500  border-cyan-500 animate-bounceCustom flex bg-red-50 items-center justify-center md:h-full md:w-full   w-60 h-60    shadow-lg shadow-cyan-700 p-1 border-cyan-600 border '>
            <img src={assets.my_pic} className='rounded-full h-full w-full ' alt="Prabhanjan Satish Dhobale" />
          </div>
        </div>
      </div>
    </div>
